 ...
 */
	...
	public static void addTeamMembers (String[] team) {
		System.out.println("Enter the name of the team member: ");
	...
	public static void deleteTeamMember(String[] team) {
		System.out.println("Which team member do you like to delete?");
